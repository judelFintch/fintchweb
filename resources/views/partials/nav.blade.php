    ...
    <nav class="flex justify-between items-center gap-4 py-4">
      ...
      <div data-nav-bar class="absolute scale-50 origin-top-left invisible top-[calc(100%+8px)]
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="/contact" class="flex justify-center items-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-full font-semibold text-sm transition-all duration-300 shadow-md shadow-blue-200 w-full lg:w-auto">
            Devis gratuit
          </a>
        </div>
      </div>
